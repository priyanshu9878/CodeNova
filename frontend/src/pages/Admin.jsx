...
function Admin() {
  ...
  const adminOptions = [
    ...
    },
    {
      id: 'video',
      title: 'Video Problem',
      description: 'Upload and Remove videos from the platform',
      icon: Video,
      color: 'btn-error',
      bgColor: 'btn btn-secondary',
      route: '/admin/video'
    }
  ];

  return (
    <div className="min-h-screen bg-linear-to-br from-zinc-950 via-zinc-900 to-emerald-650/80 text-zinc-100">
