...
function AdminUpload(){
  ...
  console.log("problemId =", params.problemId);
  ...
  const problemId = params.problemId;
   ...
   //     console.log("Requesting:", `/video/create/${problemId}`);
        try {
          ...
          const uploadResponse = await axios.post(upload_url, formData, {
            headers: {
              'Content-Type': 'multipart/form-data', // axios because data type changes from json to multi part + axiosclient sends to localhost 3000  and we've to send to claudinary
            },
